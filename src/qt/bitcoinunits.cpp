...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DAG");
    case mBTC: return QString("mDAG");
    case uBTC: return QString::fromUtf8("μDAG");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("DashGolds"));
    case mBTC: return QString(QObject::tr("Milli-DashGolds (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-DashGolds (1 / 1,000,000)"));
    default: return QString("???");
    }
}
